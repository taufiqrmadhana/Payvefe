        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400">View payroll history and financial insights</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="relative">
                <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                <select 
                  className="h-11 pl-10 pr-8 bg-slate-800/50 border border-white/10 rounded-xl text-white text-sm focus:outline-none focus:border-cyan-500/50 appearance-none"
                >
                  <option className="bg-slate-800">January 2026</option>
                  <option className="bg-slate-800">December 2025</option>
                  <option className="bg-slate-800">November 2025</option>
                </select>
              </div>
