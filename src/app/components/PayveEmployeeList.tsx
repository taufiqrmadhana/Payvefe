  ...
  return (
    <div className="flex h-screen bg-slate-950">
      ...
      <div className="flex-1 p-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm font-semibold border border-blue-500/30">
                  75 employees
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Button 
                ...
                className="h-11 px-6 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white rounded-xl hover:shadow-xl hover:shadow-cyan-500/50 transition-all font-semibold"
              >
        ...
        {/* Tabs */}
        <div className="mb-6 flex items-center gap-2 bg-slate-800/50 rounded-xl p-1 border border-white/10 inline-flex">
          {[
